...
?>
        ...
        <h2 class="text-center pt-4" style="color:white; background-color:#191970; font-weight:600">ADD USER</h2>
        <br>
        ...
        <div class="screen-body-item">
          <form class="app-form" method="post">
            ...
            <div class="app-form-group button">
              <input class="app-form-button" style="color:black; background-color: #009292;"  type="submit" value="CREATE USER" name="submit"></input>
              <input class="app-form-button" style="color:black; background-color: #009292;" type="reset" value="RESET" name="reset"></input>
            </div>
          </form>
        </div>
      </div>
